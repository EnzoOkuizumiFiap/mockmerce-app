...
const styles = StyleSheet.create({
  ...
  name: { flex: 1, fontSize: 14, color: theme.colors.dark },
  sub: { fontSize: 14, fontWeight: '600', color: theme.colors.primaryDark },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 8, paddingTop: 8, borderTopWidth: 1, borderTopColor: theme.colors.greyLight },
